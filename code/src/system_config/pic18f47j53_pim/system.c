...
#include "usb.h"
#include "../../../Qy@ 2.5.X/USB Device - Qy@/v2015_08_10/apps/usb/device/cdc_serial_emulator/firmware/usb device - qy@.x/Interrupts.h"
...
#ifdef _HTC_EDITION_ < 2
    //Create a reference to the Interrupt vector for the complier
    if(0) highIntVect();
#endif
}
