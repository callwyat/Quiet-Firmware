...
#define ERROR_CODE_INVALID_NUMBER_MODE      0x0010
#define ERROR_CODE_INVALID_RESTORE_ARG      0x0011

#define ERROR_CODE_INVALID_SERIAL_NUMBER_TYPE 0x0020
#define ERROR_CODE_SERIAL_NUMBER_TO_LONG    0x0021
